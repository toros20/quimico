...
<div id="wrapper">
 ...
 <div class="about2-area" style="padding: 20px 0;">
    <div class="container">
        <h1 class="about-title">Juramentación Febrero 2020</h1>
    </div>
</div>
...
<div class="gallery-area2" style="padding: 10px 0 93px;">
    <div class="container" id="inner-isotope">
        ...
        <div class="row featuredContainer gallery-wrapper">
            ...
            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 room auditoriam class">
                <div class="gallery-box">
                    <img src="img/juramentacion_02_2020/6.jpg" class="img-responsive" alt="gallery">
                    <div class="gallery-content">
                        <a href="img/juramentacion_02_2020/6.jpg" class="zoom"><i class="fa fa-link" aria-hidden="true"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 room auditoriam class">
                <div class="gallery-box">
                    <img src="img/juramentacion_02_2020/7.jpg" class="img-responsive" alt="gallery">
                    <div class="gallery-content">
                        <a href="img/juramentacion_02_2020/7.jpg" class="zoom"><i class="fa fa-link" aria-hidden="true"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 room auditoriam class">
