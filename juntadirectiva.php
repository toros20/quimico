...
<div id="wrapper">
 ...
 <div class="about2-area" style="padding: 20px 0;">
    <div class="container">
        <h1 class="about-title">Junta Directiva 2017-2020</h1>
        <p class="about-sub-title">Presentamos los miembros de nuestra Junta Directiva</p>
    </div>
</div>
                ...
                <div class="single-item">
                    <div class="lecturers1-item-wrapper">
                        ...
                        <div class="lecturers-content-wrapper">
                            ...
                            <span class="item-designation">Dra. María David </span>
                            <ul class="lecturers-social">
                                <li><a href="#"><i class="fa fa-envelope-o" aria-hidden="true"></i></a></li>
                                <li><a href="#"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
                            </ul>
                ...
                <div class="single-item">
                    <div class="lecturers1-item-wrapper">
                        ...
                        <div class="lecturers-content-wrapper">
                            ...
                            <span class="item-designation">Dra. Suyapa Lagos </span>
                            <ul class="lecturers-social">
                                <li><a href="#"><i class="fa fa-envelope-o" aria-hidden="true"></i></a></li>
                                <li><a href="#"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
                            </ul>
                ...
                <div class="single-item">
                    <div class="lecturers1-item-wrapper">
                        ...
                        <div class="lecturers-content-wrapper">
                            ...
                            <span class="item-designation">Dr. José Nelson Jiménez </span>
                            <ul class="lecturers-social">
                                <li><a href="#"><i class="fa fa-envelope-o" aria-hidden="true"></i></a></li>
                                <li><a href="#"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
                            </ul>
                ...
                <div class="single-item">
                    <div class="lecturers1-item-wrapper">
                        ...
                        <div class="lecturers-content-wrapper">
                            ...
                            <span class="item-designation">Dra. Lourdes Moncada</span>
                            <ul class="lecturers-social">
                                <li><a href="#"><i class="fa fa-envelope-o" aria-hidden="true"></i></a></li>
                                <li><a href="#"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
                            </ul>
                ...
                <div class="single-item">
                    <div class="lecturers1-item-wrapper">
                        ...
                        <div class="lecturers-content-wrapper">
                            ...
                            <span class="item-designation">Dr. Nieves Jesús Martínez </span>
                            <ul class="lecturers-social">
                                <li><a href="#"><i class="fa fa-envelope-o" aria-hidden="true"></i></a></li>
                                <li><a href="#"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
                            </ul>
                ...
                <div class="single-item">
                    <div class="lecturers1-item-wrapper">
                        ...
                        <div class="lecturers-content-wrapper">
                            ...
                            <span class="item-designation">Dr. Héctor Díaz Del Valle </span>
                            <ul class="lecturers-social">
                                <li><a href="#"><i class="fa fa-envelope-o" aria-hidden="true"></i></a></li>
                                <li><a href="#"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
                            </ul>
                ...
                <div class="single-item">
                    <div class="lecturers1-item-wrapper">
                        ...
                        <div class="lecturers-content-wrapper">
                            ...
                            <span class="item-designation">Dr. Alma Pizzati</span>
                            <ul class="lecturers-social">
                                <li><a href="#"><i class="fa fa-envelope-o" aria-hidden="true"></i></a></li>
                                <li><a href="#"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
                            </ul>
                ...
                <div class="single-item">
                    <div class="lecturers1-item-wrapper">
                        ...
                        <div class="lecturers-content-wrapper">
                            ...
                            <span class="item-designation">Dr. César Andrade</span>
                            <ul class="lecturers-social">
                                <li><a href="#"><i class="fa fa-envelope-o" aria-hidden="true"></i></a></li>
                                <li><a href="#"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
                            </ul>
